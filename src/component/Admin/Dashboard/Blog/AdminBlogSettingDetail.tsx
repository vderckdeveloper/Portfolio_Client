...
import { Editor, EditorState, AtomicBlockUtils, RichUtils, CompositeDecorator, ContentBlock, ContentState, convertToRaw, convertFromRaw } from 'draft-js';

import styles from '@/styles/Admin/Dashboard/Blog/AdminBlogSettingDetail.module.css';
...
interface AdminBlogSettingDetailProps {
    blogSubData: BlogSubData;
    onCloseSettingDetail: () => void;
}
...
export default AdminBlogSettingDetail;