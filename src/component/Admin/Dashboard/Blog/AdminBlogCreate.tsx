    ...
    return (
        <div className={styles.container} onClick={focusEditor}>
            <div className={styles.tool}>
                ...
                <button onMouseDown={(e) => { onToggleBlockType(e, 'header-one') }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" stroke="#000000" fill="#000000" strokeWidth="0" viewBox="0 0 24 24"><path fill="none" d="M0 0H24V24H0z"></path><path d="M13 20h-2v-7H4v7H2V4h2v7h7V4h2v16zm8-12v12h-2v-9.796l-2 .536V8.67L19.5 8H21z"></path></svg>
                </button>
                <button onMouseDown={(e) => { onToggleBlockType(e, 'header-two') }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" stroke="#000000" fill="#000000" strokeWidth="0" viewBox="0 0 24 24">
                        <path fill="none" d="M0 0H24V24H0z"></path>
                ...
                <button onMouseDown={(e) => { onToggleBlockType(e, 'header-three') }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" stroke="#000000" fill="#000000" strokeWidth="0" viewBox="0 0 24 24">
                        <path fill="none" d="M0 0H24V24H0z"></path>
