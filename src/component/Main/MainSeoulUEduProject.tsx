...
// image
import mainSeoulUEduProjectSlideImageOne from '../../../public/image/main/mainProject/mainSeoulUEduProject/240417_mainSeoulUEdu_slideImage(1)_Ver1.0.png';
import mainSeoulUEduProjectSlideImageTwo from '../../../public/image/main/mainProject/mainSeoulUEduProject/240417_mainSeoulUEdu_slideImage(2)_Ver1.0.png';
import mainSeoulUEduProjectSlideImageThree from '../../../public/image/main/mainProject/mainSeoulUEduProject/240417_mainSeoulUEdu_slideImage(3)_Ver1.0.png';
import mainSeoulUEduProjectSlideImageFour from '../../../public/image/main/mainProject/mainSeoulUEduProject/240417_mainSeoulUEdu_slideImage(4)_Ver1.0.png';
        ...
        <section className={styles.container}>
            <div className={styles.wrapper}>
                    ...
                    <div className={styles.bodyRightSection}>
                        ...
                        <section>
                            ...
                            <div>
                                ...
                                <span>
                                    Next JS, Express, Nest JS, Maria DB, Redis, Nginx, Google Cloud Platform
                                </span>
                            </div>
                        </section>
                ...
                <div className={styles.bottomSection}>
                    ...
                    <p>BM 모델은 온라인 강의, 멘토링 시스템, 부트캠프로 세가지 상품에 대해 유저, 크리에이터, 관리자의 상호작용이 가능하도록 개발했습니다.</p>
                    <p>반응형 플랫폼으로 PC, 태블릿, 모바일에서 전부 이용가능합니다. Next js를 이용하여, 페이지 사이의 이동이 자유로움과 동시에 SEO 최적화가 가능한 비즈니스 플랫폼을 구상하여 설계하였습니다.</p>
                    <p>또한, PWA(Progressive Web Application)기술을 도입하여, 휴대폰 앱으로 다운받아 사용 가능합니다.</p>
                    <p>2024년 3월 현재, Google Lighthouse 기준으로 SEO 점수는 100점입니다.</p>
                    ...
                    <figure className={styles.imageBox}>
                        <Image src={mainSeoulUEduProjectSlideImageFour} width={800} height={600} alt='서울 유 에듀 프로젝트 슬라이드 첫번째 이미지' quality={100} />
                        <figcaption>설계 사진</figcaption>
                    </figure>
                    <p>프로젝트의 설계 구조입니다. DB ERD 구조를 도식화하여 총 45개의 테이블 관계를 간략히 표현하였습니다.
                        ...
                        (채팅 서버의 경우는 따로 분리하여, Nest JS로 구축하였습니다)
